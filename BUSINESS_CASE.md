...
- **Not a silicon company.** We do not sell hardware. As Platform Provider we deliver the reference schematics, PCB layout, and BSP integration; the OEM (or their contract manufacturer / EMS supplier) builds the ECU. OEMs with in-house hardware capability can build it themselves.
