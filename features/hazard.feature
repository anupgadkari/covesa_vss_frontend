Feature: Hazard Lighting
  ...
  # Requirements
  # -------------------------------------------------------------------------
  # REQ-HAZ-001: When Vehicle.Body.Lights.Hazard.Switch.IsEngaged transitions to TRUE,
  ...
  #
  # REQ-HAZ-002: When Vehicle.Body.Lights.Hazard.Switch.IsEngaged transitions to FALSE,
  ...
  #              input (Vehicle.Body.Lights.Hazard.Switch.IsEngaged), NOT the actuator
