Feature: Perimeter Alarm (anti-intrusion alarm on unauthorised door open)
  ...
  # Requirements
  # -------------------------------------------------------------------------
  # REQ-PERI-001: When Vehicle.Cabin.LockStatus transitions from a non-armable
  ...
  #
  # REQ-PERI-003: When Vehicle.Cabin.LockStatus transitions from an armable state
  ...
  #               transitions FALSE→TRUE while Vehicle.Cabin.LockStatus is LOCKED
  ...
  #
  # REQ-PERI-009: When Vehicle.Cabin.LockStatus transitions to UNLOCKED or
  #               DRIVER_UNLOCKED AND Vehicle.Cabin.LockStatus.LastRequestor is
  ...
  Scenario: Door open during the 20 s pre-arm window is silently ignored
    Given Vehicle.Cabin.LockStatus has just transitioned to "LOCKED"
  ...
  Scenario: Door open just after the pre-arm window starts the chime phase
    Given Vehicle.Cabin.LockStatus has been "LOCKED" for at least 20 seconds
    When the driver opens the Row1.Left door
  ...
  Scenario: LOCKED → DOUBLE_LOCKED does not restart the pre-arm timer
    Given Vehicle.Cabin.LockStatus has been "LOCKED" for 15 seconds
    When Vehicle.Cabin.LockStatus transitions to "DOUBLE_LOCKED"
  ...
  Scenario: Unlock-then-relock resets the pre-arm window
    Given Vehicle.Cabin.LockStatus has been "LOCKED" for 15 seconds
    When Vehicle.Cabin.LockStatus transitions to "UNLOCKED"
    And Vehicle.Cabin.LockStatus transitions back to "LOCKED"
  ...
  Scenario: Authenticated unlock during full alarm disarms immediately
    Given a PerimeterAlarm sequence is in the full-alarm phase
    When Vehicle.Cabin.LockStatus transitions to "UNLOCKED"
    And Vehicle.Cabin.LockStatus.LastRequestor becomes "PassiveEntry"
  ...
  Scenario: Thumb-pad unlock does NOT disarm a running alarm
    Given a PerimeterAlarm sequence is in the full-alarm phase
    When Vehicle.Cabin.LockStatus transitions to "UNLOCKED"
    And Vehicle.Cabin.LockStatus.LastRequestor becomes "KeypadLock"
  ...
  Scenario: Authenticated unlock during chime phase produces no exterior output
    ...
    When Vehicle.Cabin.LockStatus transitions to "UNLOCKED"
    And Vehicle.Cabin.LockStatus.LastRequestor becomes "KeyfobRke"
