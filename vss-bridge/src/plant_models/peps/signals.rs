...
// #14 follow-up).
pub const KEYFOB_1_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.1.PlacedZone";
pub const KEYFOB_2_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.2.PlacedZone";
pub const KEYFOB_3_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.3.PlacedZone";
pub const KEYFOB_4_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.4.PlacedZone";
pub const KEYFOB_5_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.5.PlacedZone";
pub const KEYFOB_6_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.6.PlacedZone";
...
pub const KEYFOB_1_BUTTON: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.1.ButtonPress";
pub const KEYFOB_2_BUTTON: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.2.ButtonPress";
pub const KEYFOB_3_BUTTON: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.3.ButtonPress";
pub const KEYFOB_4_BUTTON: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.4.ButtonPress";
...
pub const KEYFOB_1_PAIRED: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.1.Paired";
pub const KEYFOB_2_PAIRED: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.2.Paired";
pub const KEYFOB_3_PAIRED: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.3.Paired";
pub const KEYFOB_4_PAIRED: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.4.Paired";
pub const KEYFOB_5_PAIRED: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.5.Paired";
pub const KEYFOB_6_PAIRED: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.6.Paired";
...
pub const KEYFOB_1_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.1.RssiResponse";
pub const KEYFOB_2_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.2.RssiResponse";
pub const KEYFOB_3_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.3.RssiResponse";
pub const KEYFOB_4_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.4.RssiResponse";
pub const KEYFOB_5_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.5.RssiResponse";
pub const KEYFOB_6_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.6.RssiResponse";
...
pub const KEYFOB_1_RF_MSG: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.1.RfMessage";
pub const KEYFOB_2_RF_MSG: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.2.RfMessage";
pub const KEYFOB_3_RF_MSG: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.3.RfMessage";
pub const KEYFOB_4_RF_MSG: VssPath = "Vehicle.Simulation.PEPS.Plant.KeyFob.4.RfMessage";
...
pub const PHONE_1_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.BlePhone.1.PlacedZone";
pub const PHONE_2_PLACED_ZONE: VssPath = "Vehicle.Simulation.PEPS.Plant.BlePhone.2.PlacedZone";
...
pub const PHONE_1_LAST_OBSERVED_ZONE: VssPath =
    "Vehicle.Simulation.PEPS.Plant.BlePhone.1.LastObservedZone";
pub const PHONE_2_LAST_OBSERVED_ZONE: VssPath =
...
pub const PHONE_1_CHALLENGE_RESP: VssPath =
    "Vehicle.Simulation.PEPS.Plant.BlePhone.1.ChallengeResponse";
pub const PHONE_2_CHALLENGE_RESP: VssPath =
...
pub const PHONE_1_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.BlePhone.1.RssiResponse";
pub const PHONE_2_RSSI: VssPath = "Vehicle.Simulation.PEPS.Plant.BlePhone.2.RssiResponse";

pub const PHONE_RSSIS: [VssPath; 2] = [PHONE_1_RSSI, PHONE_2_RSSI];

// ── NFC Card Position (input: set by HMI / test) ──────────────────────
pub const NFC_1_POSITION: VssPath = "Vehicle.Simulation.PEPS.Plant.NfcCard.1.Position";
pub const NFC_2_POSITION: VssPath = "Vehicle.Simulation.PEPS.Plant.NfcCard.2.Position";
...
pub const NFC_1_CHALLENGE_RESP: VssPath =
    "Vehicle.Simulation.PEPS.Plant.NfcCard.1.ChallengeResponse";
pub const NFC_2_CHALLENGE_RESP: VssPath =
