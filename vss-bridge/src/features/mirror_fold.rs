...
//! - **`Vehicle.Body.Mirrors.Left.IsFolded` / `Vehicle.Body.Mirrors.Right.IsFolded`** —
...
//! # Outputs
//!
//! - **`Vehicle.Controller.Body.Mirror.Left.FoldCmd` / `Vehicle.Controller.Body.Mirror.Right.FoldCmd`** —
